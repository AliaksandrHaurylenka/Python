...
# matrix = [[matrix[i] for i in range(0, 3)] for j in matrix]
# print(matrix)
...
# lst = [i for i in t]
# a = [t[i].split() for i in range(len(t))]
# print(a)
# print(a[0][3])
# print(len(a[0][3]))
# print(len(a[0]))

# lst = [[row.split()] for row in t]
# print(lst)
...
print([[i for i in s.split() if len(i) > 3] for s in t])
